        ...
        <div className='mt-16 pb-16'>
            ...
            {myOrders.length === 0 ? (
                <div className='flex flex-col items-center justify-center mt-20 py-10'>
                    ...
                    <p className='text-2xl text-gray-500 font-medium'>No orders yet!</p>
                    <p className='text-gray-400 mt-2'>Looks like you haven't placed any orders.</p>
                    <button onClick={() => navigate('/products')} className='mt-8 px-10 py-3 bg-primary text-white rounded-lg hover:bg-primary-dull transition-all shadow-md hover:shadow-lg cursor-pointer font-medium'>
                        Start Shopping
                    </button>
                </div>
            ) : (
